...
import { isBrowser, parseProperties, setMode, isDevelopment, isProduction } from './utils';
 ...
 */
function track(name: string, properties?: Record<string, AllowedPropertyValues>): void {
  if (!isBrowser()) {
    // eslint-disable-next-line no-console
    console.warn(
