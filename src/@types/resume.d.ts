declare module 'resume' {
  export interface Occupation {
    ...
    /**
     * The end date of the occupation. If undefined or null, may be interpreted
  ...
  /**
   * A project an individual may have participated in during their professional
   * career.
   */
  ...
  export interface Meta {
    ...
    /** The date that the resume was last modified. */
    lastModified?: Date;
  }
  ...
  /**
   * Resume of an individual defined using the JSON Resume schema.
   *
